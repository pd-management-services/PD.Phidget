namespace PD.Phidget.UserInterface.Configurator.Control {
    ...
    public class ScrollViewerExtensions { //Reference: https://stackoverflow.com/questions/2984803/how-to-automatically-scroll-scrollviewer-only-if-the-user-did-not-change-scrol
